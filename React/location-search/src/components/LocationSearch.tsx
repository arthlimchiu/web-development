    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <input id="term" value={term} onChange={e => setTerm(e.target.value)} className="border border-gray-300 rounded-md shadow-sm focus:border-indigo-500 px-4 py-2 w-full" />
            </form>
